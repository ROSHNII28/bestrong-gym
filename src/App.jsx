...
function App() {
  ...
  const handleOpenBookModal = (programName = 'General Gym Membership') => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-bg text-text-light font-body antialiased">
      {/* Responsive Navigation Header */}
      <Navbar onBookSessionClick={() => handleOpenBookModal()} />

      {/* Main Pages/Sections */}
      <main className="flex-grow">
        {/* Home Section */}
        <Hero onBookSessionClick={() => handleOpenBookModal('Free Trial Session')} />

        {/* About Section */}
        <About />

        {/* Services / Programs Section */}
        <Services onBookSessionClick={(progName) => handleOpenBookModal(progName)} />

        {/* Trainers Section */}
        <Trainers onBookTrainerClick={(trainerName) => handleOpenBookModal(trainerName)} />

        {/* Membership Plans Section */}
        <Membership onBookSessionClick={(planName) => handleOpenBookModal(planName)} />
